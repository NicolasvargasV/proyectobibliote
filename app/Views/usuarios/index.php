...
<div class="container-sm">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav mr-auto my-2 my-lg-0 navbar-nav-scroll" style="max-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.sectormatematica.cl/educmedia.htm">guias practicas
                            
                        </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="http://www.iesboliches.org/tecnologia/index.php/16-videos-tecnicas-estudio">tecnicas de estudio
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="http://www.iesboliches.org/tecnologia/index.php/libros">Libreria  
                    </a>
                </li>
              ...
              .btn btn-success {float:left;}
                <li><a type="button" href="<?php echo base_url("signin");?>" class="btn btn-success"  float ='right' >INGRESAR</a></li>
...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12  col-md-4 col-lg-6 col-xl-3 border texto">
                <h3>Unidad de estudio</h3>Fija un tema a estudiar y estúdialo. Organizar información relacionada entre sí por el hecho de permanecer a un tema o categoría de cualquier clase es mucho más fácil que estudiar piezas de información dispersas y desordenadas. Para eso es bueno que leas la lección una vez para crear un mapa mental de la localización de los temas en el texto y luego te focalices en cada uno de ellos.

Eso sí, cuando repases la información estudiada (algo que deberías hacer muy a menudo, como veremos), es mejor que no lo hagas de un solo tema, sino que incluyas elementos de varios
...
De lo que se trata es de mantener el cerebro al 100% en cada momento (por cierto, mantener el sueño a raya es sagrado, y para eso nada como dormir bien).</div>
                

            </div>
            <div class="col-sm-12  col-md-4 col-lg-6 col-xl-3 border texto ">
                <h3>Mayor productividad</h3>
                Si te interesa primero conocer los textos o documentos sobre determinada materia para después investigar acerca de los diversos formatos que aportan a lo que aprendiste es adecuado que consultes las bibliografías en materiales escaneados disponibles en nuestra pagina, tener en cuenta un horario de estudio y seguirlo no sirve sólo para ofrecer una imagen de madurez y pulcritud ya que tiene efectos notables sobre el rendimiento de estudio. Abordar el aprendizaje de manera desorganizada es una manera de terminar estudiando a altas horas de la noche
